...
namespace Math3d
{
    public static class Math
    {
        ...
        public static int IAbs(int iValue) => iValue >= 0 ? iValue : -iValue;

        public static int ICeil(float value) => (int)System.Math.Ceiling(value);

        public static int IFloor(float value) => (int)System.Math.Floor(value);

        public static int ISign(int iValue) => iValue > 0 ? +1 : (iValue < 0 ? -1 : 0);

        public static float Abs(float fValue) => System.Math.Abs(fValue);

        public static Radian ATan(float value) => new Radian((float)System.Math.Atan(value));

        public static Radian ATan2(float fY, float fX) => new Radian((float)System.Math.Atan2(fY, fX));

        public static float Sin(float value) => (float)System.Math.Sin(value);

        public static float InvSqrt(float fValue) => (float)(1.0f / System.Math.Sqrt(fValue));

        public static float Sin(Radian radians) => (float)System.Math.Sin(radians.ValueRadians);

        public static float Cos(float value) => (float)System.Math.Cos(value);

        public static float Cos(Radian value) => (float)System.Math.Cos(value.ValueRadians);

        public static float Sqrt(float value) => (float)System.Math.Sqrt(value);

        public static Radian Sqrt(Radian value) => new Radian((float)System.Math.Sqrt(value.ValueRadians));

        public static float Sqr(float value) => value * value;

        public static float DegreesToRadians(float degrees) => degrees * fDeg2Rad;

        public static float RadiansToDegrees(float radians) => radians * fRad2Deg;
        ...
        public static float UnitRandom() => (float)_randomizer.NextDouble();

        public static float RangeRandom(float fLow, float fHigh) => ((fHigh - fLow) * UnitRandom()) + fLow;
        ...
        public static Tuple<bool, float> Intersects(Ray ray, Vector3 a, Vector3 b, Vector3 c) => Intersects(ray, a, b, c, true, true);

        public static Tuple<bool, float> Intersects(Ray ray, Vector3 a, Vector3 b, Vector3 c, bool positiveSide) => Intersects(ray, a, b, c, positiveSide, true);
        ...
        public static Tuple<bool, float> Intersects(Ray ray, Vector3 a, Vector3 b, Vector3 c, Vector3 normal) => Intersects(ray, a, b, c, normal, true, true);
        ...
        internal static float Sin(double v)
        {
