...
namespace Math3d
{
    ...
    public struct Radian : IEquatable<Radian>, IComparable<Radian>
    {
        ...
        public float ValueAngleUnits => Math.RadiansToAngleUnits(_value);

        public float ValueRadians => _value;

        public float ValueDegrees => Math.RadiansToDegrees(_value);

        public Radian(Degree d) => _value = d.ValueRadians;

        public Radian(float r) => _value = r;
