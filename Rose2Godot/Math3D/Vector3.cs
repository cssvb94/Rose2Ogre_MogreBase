...
namespace Math3d
{
    ...
    public struct Vector3 : IEquatable<Vector3>, IFormattable
    {
        ...
        public bool Equals(ref Vector3 other) => X == other.X && Y == other.Y && Z == other.Z;
        ...
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator Vector4(Vector3 value) => new Vector4(value, 0.0f);

        /// <summary>
        /// Returns a String representing this Vector3 instance.
        /// </summary>
        /// <returns>The string representation.</returns>
        public override string ToString() => string.Format(CultureInfo.CurrentCulture, "Vector3({0:0.######}, {1:0.######}, {2:0.######})", X, Y, Z);
        ...
        public string ToString(string format)
        {
            ...
            return string.Format(CultureInfo.CurrentCulture, "Vector3({0:0.######}, {1:0.######}, {2:0.######})", X, Y, Z);
        }
        ...
        /// </returns>
        public string ToString(IFormatProvider formatProvider) => string.Format(formatProvider, "Vector3({0:0.####}, {1:0.####}, {2:0.####})", X, Y, Z);
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            return string.Format(formatProvider, "Vector3({0:0.####}, {1:0.####}, {2:0.####})", X, Y, Z);
        }
