    ...
    public struct MinMax<T>
    {
        ...
        public T Random
        {
            get
            {
                if (typeof(T) == typeof(int))
                {
                    ...
                    return (T)(object)((random.Next(0, short.MaxValue) % (System.Math.Abs(maximum - minimum) + 1)) + minimum);
                }
        ...
        public T Range
        {
            get
            {
                if (typeof(T) == typeof(int))
                {
                    return (T)(object)System.Math.Abs((int)(object)Maximum - (int)(object)Minimum);
                }

                if (typeof(T) == typeof(float))
                {
                    return (T)(object)System.Math.Abs((float)(object)Maximum - (float)(object)Minimum);
                }
                ...
                if (typeof(T) == typeof(Vector2))
                {
                    ...
                    float x = System.Math.Abs(maximum.X - minimum.X);
                    float y = System.Math.Abs(maximum.Y - minimum.Y);
                ...
                if (typeof(T) == typeof(Vector3))
                {
                    ...
                    float x = System.Math.Abs(maximum.X - minimum.X);
                    float y = System.Math.Abs(maximum.Y - minimum.Y);
                    float z = System.Math.Abs(maximum.Z - minimum.Z);
                ...
                if (typeof(T) == typeof(Vector4))
                {
                    ...
                    float y = System.Math.Abs(maximum.Y - minimum.Y);
                    float z = System.Math.Abs(maximum.Z - minimum.Z);
                    float w = System.Math.Abs(maximum.W - minimum.W);
                ...
                if (typeof(T) == typeof(Color4))
                {
                    ...
                    float r = System.Math.Abs(maximum.Red - minimum.Red);
                    float g = System.Math.Abs(maximum.Green - minimum.Green);
                    float b = System.Math.Abs(maximum.Blue - minimum.Blue);
                    float a = System.Math.Abs(maximum.Alpha - minimum.Alpha);
        ...
        private static float RandomNumber(float minimum, float maximum)
        {
            ...
            return ((random.Next(0, short.MaxValue) / (float)short.MaxValue) * System.Math.Abs(maximum - minimum)) + minimum;
        }
    }
}